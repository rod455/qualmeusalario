  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.container}>
        ...
        <Text style={s.sub}>Simule uma conversa com o RH usando seus dados reais e chegue preparado para pedir aumento.</Text>
        <View style={s.perks}>
          {[
            { icon:'🤖', text:'IA simula o RH com seus dados reais' },
            { icon:'📝', text:'Script pronto baseado no seu gap' },
            { icon:'🎯', text:'3 níveis: fácil, médio e difícil' },
            { icon:'📊', text:'Quanto exatamente pedir de aumento' },
          ].map(p => (
